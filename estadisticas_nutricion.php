...
<head>
    ...
    <title>Campus Virtual | Estadisticas - Examen de Nutrición</title>
</head>
...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h2>Estadisticas sobre el examen de nutrición</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
